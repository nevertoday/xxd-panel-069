...
المتاح حالياً هو الموجّه الأصلي فقط، من دون نماذج أصلية موثقة على X أو رابط مصدر. لذلك تبقى `sample-01`–`04` للأعمال الأصلية المستقبلية، و`sample-05`–`12` لنماذج إضافية تخضع للمراجعة الفردية. لا تُعرض الصور المولدة بوصفها أعمالاً أصلية.
