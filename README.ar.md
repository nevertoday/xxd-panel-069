...
# 🦁 XXD Panel 069｜نافذة اللطخات الزاهية

### يعيد تنظيم الصور عبر نافذة مطلية بفرشاة عريضة وألوان حية وحدود يدوية رفيعة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 069 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تتحول كثير من معالجات الصور إلى بقعة مائية ناعمة تحيط بالصورة، بينما تبقى الفرشاة والفراغ والكتابة عناصر منفصلة.

يجعل **Panel 069** النافذة غير المنتظمة، المرسومة فعلياً بفرشاة كبيرة، هي الشكل الرئيسي في التكوين. تبني الكتل العريضة الاتجاه والنظام التحريري، وتحفظ الحدود اليدوية الرفيعة هوية العنصر، بينما تمنح ألوان المصدر الأكثر حيوية وقليل من الطلاء السميك حياة للصورة. وقد تتجاوز السمات الأساسية حدود الفرشاة لتربط اللون والفراغ والعنصر والنص في إخراج فني واحد.

### مناسب لـ

- الحفاظ على وضوح الأشخاص والمباني والحيوانات والنباتات والأغراض والمناظر؛
- ألوان مشرقة ومريحة من دون مرشحات متسخة أو تشبع سكري رخيص؛
- تخطيطات تجمع الطلاء العريض والفراغ المضيء وتجاوز الحدود والنص القليل في إيقاع واحد؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 069 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** نافذة فرشاة عريضة · ألوان مصدر حية · حدود رفيعة · تجاوز الحواف · فراغ أبيض دافئ · مزج حر بين الصورة والنص
...
|---|---|
| **الناتج** | صورة تحريرية مشرقة تنظمها كتل لونية عريضة وخطوط يدوية رفيعة |
| **البصمة الواضحة** | نافذة غير منتظمة مرسومة بفرشاة كبيرة، يظهر منها العنصر وتتجاوز سماته حوافها |
| **احترام المصدر** | يحافظ على الهوية والوضعية والعلاقات، ويعيد مزج أكثر ألوان الصورة حيوية بدلاً من فرض لوحة خارجية ثابتة |
...
```text
تثبيت الهوية والعلاقة → حذف الخلفية الثانوية → العثور على أقوى اتجاه → بناء نافذة غير منتظمة بعدة ضربات عريضة → إظهار العنصر بخطوط رفيعة ولون انتقائي → تجاوز السمات الأساسية لحافة الفرشاة → إعادة مزج أكثر ألوان المصدر حيوية → ترتيب نص قليل داخل فراغ أبيض دافئ
```

## سمات النتيجة النهائية

- تُظهر النافذة شعيرات الفرشاة والانقطاعات الجافة وتفاوت السماكة والحواف الخشنة والبياض المكشوف.
- هي شكل تكويني أساسي، لا هالة مائية ناعمة ولا إطار منتظم ولا قناع صورة.
- تحفظ أشكال قليلة وضوح المصدر، بينما تتجاوز النباتات أو الأشخاص أو القمم أو الحدود حافة الطلاء.
- تصنع الكتل العريضة والخطوط الرفيعة فرقاً مقصوداً في المقياس، مع طلاء سميك محدود عند البؤر.
- تأتي الألوان من أكثر علاقات المصدر إشراقاً وحيوية، ويوازنها فراغ أبيض دافئ واسع.
- تنشأ الكتابة من الصورة الحالية وتستجيب لاتجاه الفرشاة أو للأشكال المتجاوزة للحدود.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-069-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 069. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-069 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-069 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-069 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-069 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-069 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 069 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-069 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-069`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-069-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-069-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ69 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 069 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–069) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
